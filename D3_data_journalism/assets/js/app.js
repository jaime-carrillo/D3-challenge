...
function makeResponsive() {
  ...
  d3.csv("assets/data/data.csv").then(function(statsData, err) {
    if (err) throw err;
    ...
    var xLinearScale = xScale(statsData, chosenXAxis, width);
  
    // Create y scale 
    var yLinearScale = yScale(statsData, chosenYAxis, height);
    ...
    xlabelsGroup.selectAll("text")
      .on("click", function() {
        ...
        if (value !== chosenXAxis) {
          ...
          xLinearScale = xScale(statsData, chosenXAxis, width);
      ...
      .on("click", function() {
        ...
        if (value !== chosenYAxis) {
          ...
          // functions here found above csv import
          // updates x scale for new data
          yLinearScale = yScale(statsData, chosenYAxis, height);
